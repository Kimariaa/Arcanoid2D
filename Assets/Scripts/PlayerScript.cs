...
public class PlayerScript : MonoBehaviour
{
    ...
    public void Bonus()
    {
        //DestroyAllBall and restart lvl
        ...
        GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerScript>().StartLevel();
    }
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Pause") && !startMenu.active)
        {
            if (Time.timeScale > 0)
            {
                Time.timeScale = 0;
